<?php
  ...
  $pageTitle = 'Fuel Issuance';
    
  $partsTransactionReadAccess = $userModel->checkMenuItemAccessRights($user_id, 189, 'read');
  $partsTransactionCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 189, 'create');
  $partsTransactionWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 189, 'write');
  $partsTransactionDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 189, 'delete');
  $partsTransactionDuplicateAccess = $userModel->checkMenuItemAccessRights($user_id, 189, 'duplicate');
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="fuel-issuance.php"><?php echo $pageTitle; ?></a></li>
                    <?php
