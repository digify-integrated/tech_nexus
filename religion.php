...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
        ...
        <?php
          if($newRecord && $religionCreateAccess['total'] > 0){
            require_once('view/_religion_new.php');
          }
          else if(!empty($religionID) && $religionWriteAccess['total'] > 0){
            require_once('view/_religion_details.php');
          }
          else{
            require_once('view/_religion.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/religion.js?v=<?php echo rand(); ?>"></script>
</body>
