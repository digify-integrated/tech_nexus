...
$customerAddress = '';
    ...
    $pdf->Ln(25);
    $pdf->Cell(30, 4, '', 0, 0, 'L', 0, '', 1);
    $pdf->Cell(88, 4, strtoupper($customerName), 0, 0, 'L', 0, '', 1);
    $pdf->Cell(30, 4, '     ', 0, 0 , 'L', '', 1);
    $pdf->Cell(30, 4, strtoupper(date('d-M-Y')), 0, 0, 'L', 0, '', 1);
    $pdf->Cell(1, 4, '     ', 0, 0 , 'L', '', 1);
    $pdf->Cell(10, 4, $drNumber, 0, 0, 'L', 0, '', 1);
    $pdf->Ln(8);
    $pdf->Cell(25, 4, '', 0, 0, 'L', 0, '', 1);
    $pdf->Cell(93, 4, '-', 0, 0, 'L', 0, '', 1);
    $pdf->Cell(30, 4, '     ', 0, 0 , 'L', '', 1);
    //$pdf->Cell(30, 4, strtoupper($createdDate), 0, 0, 'L', 0, '', 1);
    $pdf->Cell(30, 4, '', 0, 0, 'L', 0, '', 1);
    $pdf->Ln(8);
    $pdf->Cell(25, 4, '', 0, 0, 'L', 0, '', 1);
    $pdf->Cell(93, 4, strtoupper($customerAddress), 0, 0, 'L', 0, '', 1);
    $pdf->Ln(18);
