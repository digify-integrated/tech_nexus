    ...
    switch ($transaction) {
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        ...
                        if($check_menu_groups_exist > 0){
                            $update_menu_groups = $administrator_class->update_menu_groups($menu_group_id, $menu_group_name, $order_sequence, $user_id);
                            ...
                            $insert_menu_groups = $administrator_class->insert_menu_groups($menu_group_name, $order_sequence, $user_id);
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                       ...
                       if($check_menu_item_exist > 0){
                            $update_menu_item = $administrator_class->update_menu_item($menu_item_id, $menu_item_name, $menu_group_id, $menu_item_url, $parent_id, $menu_item_icon, $order_sequence, $user_id);
                            ...
                            $insert_menu_item = $administrator_class->insert_menu_item($menu_item_name, $menu_group_id, $menu_item_url, $parent_id, $menu_item_icon, $order_sequence, $user_id);
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        foreach ($permissions as $permission) {
                            ...
                            $check_role_menu_item_access_right_exist = $administrator_class->check_role_menu_item_access_right_exist($menu_item_id, $role_id);
        
                            if($check_role_menu_item_access_right_exist == 1){
                                $update_role_menu_item_access_right = $administrator_class->update_role_menu_item_access_right($menu_item_id, $role_id, $access_type, $access);
                                ...
                                $insert_role_menu_item_access_right = $administrator_class->insert_role_menu_item_access_right($menu_item_id, $role_id);
            ...
            if(isset($_POST['email_account']) && !empty($_POST['email_account']) && isset($_POST['menu_group_id']) && !empty($_POST['menu_group_id'])){
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        ...
                        if($check_menu_groups_exist > 0){
                            $delete_all_menu_item = $administrator_class->delete_all_menu_item($menu_group_id);
                
                            if($delete_all_menu_item){
                                $delete_menu_groups = $administrator_class->delete_menu_groups($menu_group_id);
            ...
            if(isset($_POST['email_account']) && !empty($_POST['email_account']) && isset($_POST['menu_item_id']) && !empty($_POST['menu_item_id'])){
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        ...
                        if($check_menu_item_exist > 0){
                            $delete_menu_item = $administrator_class->delete_menu_item($menu_item_id);
            ...
            if(isset($_POST['email_account']) && !empty($_POST['email_account']) && isset($_POST['menu_group_id']) && !empty($_POST['menu_group_id'])){
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        ...
                        if($check_menu_groups_exist > 0){
                            $duplicate_menu_groups = $administrator_class->duplicate_menu_groups($menu_group_id, $user_id);
            ...
            if(isset($_POST['email_account']) && !empty($_POST['email_account']) && isset($_POST['menu_item_id']) && !empty($_POST['menu_item_id'])){
                ...
                if($check_user_exist === 1){
                    ...
                    if($check_user_status){
                        ...
                        if($check_menu_item_exist > 0){
                            $duplicate_menu_item = $administrator_class->duplicate_menu_item($menu_item_id, $user_id);
        ...
        case 'modal menu item details':
            if(isset($_POST['menu_item_id']) && !empty($_POST['menu_item_id'])){
                ...
                $menu_item_details = $administrator_class->get_menu_item_details($menu_item_id);
