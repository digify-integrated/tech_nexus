<?php
  ...
  $partsReadAccess = $userModel->checkMenuItemAccessRights($user_id, 187, 'read');
  $partsCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 187, 'create');
  $partsWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 187, 'write');
  $partsDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 187, 'delete');
  $partsDuplicateAccess = $userModel->checkMenuItemAccessRights($user_id, 187, 'duplicate');
