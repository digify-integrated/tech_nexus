...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="address-type.php">Address Type</a></li>
                    <?php
                        if(!$newRecord && !empty($addressTypeID)){
                            echo '<li class="breadcrumb-item" id="address-type-id">'. $addressTypeID .'</li>';
                        }
        ...
        <?php
          if($newRecord && $addressTypeCreateAccess['total'] > 0){
            require_once('view/_address_type_new.php');
          }
          else if(!empty($addressTypeID) && $addressTypeWriteAccess['total'] > 0){
            require_once('view/_address_type_details.php');
          }
          else{
            require_once('view/_address_type.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/address-type.js?v=<?php echo rand(); ?>"></script>
</body>
