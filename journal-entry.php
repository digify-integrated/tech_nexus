<?php
  ...
  $pdcManagementReadAccess = $userModel->checkMenuItemAccessRights($user_id, 123, 'read');
  $pdcManagementCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 123, 'create');
  $pdcManagementWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 123, 'write');
  $pdcManagementDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 123, 'delete');
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="journal-entry.php"><?php echo $pageTitle; ?></a></li>
                </ul>
              </div>
              <div class="col-md-12">
        ...
        <?php
            require_once('view/_journal_entry.php');
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/journal-entry.js?v=<?php echo rand(); ?>"></script>
</body>
