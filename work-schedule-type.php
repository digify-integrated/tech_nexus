            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="work-schedule-type.php">Work Schedule Type</a></li>
                    <?php
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Work Schedule Type</h2>
                </div>
              </div>
            </div>
          </div>
