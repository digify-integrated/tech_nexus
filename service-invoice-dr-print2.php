...
while ($pdf->GetStringWidth($address) > 180) {
...
function drawChattelMortgageTable($pdf, $fullStockNumber, $productDescription, $pnAmount)
{
    ...
    $pdf->MultiCell(100, 4, $productDescription, 0);
    ...
    $pdf->SetXY(35, 221);
    $pdf->Cell(25, 5, number_format(($vat + 1), 2), 0, 0, 'R');
