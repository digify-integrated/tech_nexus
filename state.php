...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
        ...
        <?php
          if($newRecord && $stateCreateAccess['total'] > 0){
            require_once('view/_state_new.php');
          }
          else if(!empty($stateID) && $stateWriteAccess['total'] > 0){
            require_once('view/_state_details.php');
          }
          else{
            require_once('view/_state.php');
          }
        ?>
      </div>
    </section>
