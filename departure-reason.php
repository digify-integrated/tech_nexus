...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="departure-reason.php">Departure Reason</a></li>
                    <?php
                        if(!$newRecord && !empty($departureReasonID)){
                            echo '<li class="breadcrumb-item" id="departure-reason-id">'. $departureReasonID .'</li>';
                        }
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Departure Reason</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <?php
          if($newRecord && $departureReasonCreateAccess['total'] > 0){
            require_once('view/_departure_reason_new.php');
          }
          else if(!empty($departureReasonID) && $departureReasonWriteAccess['total'] > 0){
            require_once('view/_departure_reason_details.php');
          }
          else{
            require_once('view/_departure_reason.php');
          }
        ?>
      </div>
    </section>
