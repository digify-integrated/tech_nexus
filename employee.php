<?php
    ...
    $employeeReadAccess = $userModel->checkMenuItemAccessRights($user_id, 45, 'read');
    $employeeCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 45, 'create');
    $employeeWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 45, 'write');
    $employeeDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 45, 'delete');
    $employeeDuplicateAccess = $userModel->checkMenuItemAccessRights($user_id, 45, 'duplicate');
