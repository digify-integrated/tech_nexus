...
CREATE INDEX liquidation_index_liquidation_id ON liquidation(liquidation_id);
CREATE INDEX liquidation_index_disbursement_particulars_id ON liquidation(disbursement_particulars_id);
...
CREATE TABLE part_return(
	part_return_id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
    reference_number VARCHAR(500),
	supplier_id INT UNSIGNED,
	company_id INT UNSIGNED,
	purchase_date DATE NOT NULL,
	ref_invoice_number VARCHAR(200),
	ref_po_number VARCHAR(200),
	ref_po_date DATE,
	prev_total_billing DOUBLE,
	adjusted_total_billing DOUBLE,
	part_return_status VARCHAR(50) NOT NULL DEFAULT 'Draft',
    for_approval DATETIME,
	approval_date DATETIME,
	released_date DATETIME,
	checked_date DATETIME,
...
CREATE TABLE part_return_cart(
	part_return_cart_id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	part_return_id INT UNSIGNED NOT NULL,
	part_transaction_id INT UNSIGNED NOT NULL,
    part_transaction_cart_id INT UNSIGNED NOT NULL,
...
CREATE TABLE purchase_order_unit(
    ...
    fx_rate DOUBLE DEFAULT 0,
    package_deal DOUBLE DEFAULT NULL,
    taxes_duties DOUBLE DEFAULT NULL,
    freight DOUBLE DEFAULT NULL,
    lto_registration DOUBLE DEFAULT NULL,
    royalties DOUBLE DEFAULT NULL,
    conversion DOUBLE DEFAULT NULL,
    arrastre DOUBLE DEFAULT NULL,
    wharrfage DOUBLE DEFAULT NULL,
    insurance DOUBLE DEFAULT NULL,
    aircon DOUBLE DEFAULT NULL,
    import_permit DOUBLE DEFAULT NULL,
    others DOUBLE DEFAULT NULL,
    sub_total DOUBLE DEFAULT NULL,
    total_landed_cost DOUBLE DEFAULT NULL,
    converted_amount DOUBLE DEFAULT NULL,
    preorder VARCHAR(5) DEFAULT NULL,
	remarks VARCHAR(5000),
	created_date DATETIME DEFAULT NOW(),
    last_log_by INT UNSIGNED NOT NULL,
    FOREIGN KEY (last_log_by) REFERENCES users(user_id)
