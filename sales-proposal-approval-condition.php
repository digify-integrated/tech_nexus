<?php
  ...
  $pageTitle = 'Sales Proposal Approval Condition';
  ...
  $allSalesProposalReadAccess = $userModel->checkMenuItemAccessRights($user_id, 178, 'read');
      ...
      <div class="pc-content">
        ...
        <?php
         if(!empty($salesProposalID) && !empty($customerID)){
            ...
            require_once('view/_sales_proposal_approval_condition.php');
          }
        ?>
      </div>
    </section>
