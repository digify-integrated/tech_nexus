<?php
  ...
  $disbursementReadAccess = $userModel->checkMenuItemAccessRights($user_id, 124, 'read');
  $disbursementCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 124, 'create');
  $disbursementWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 124, 'write');
      ...
      <div class="pc-content">
        ...
        <?php
          if($newRecord && $disbursementCreateAccess['total'] > 0){
            ...
            require_once('view/_disbursement.php');
          }
        ?>
      </div>
    </section>
