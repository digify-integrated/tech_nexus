...
INSERT INTO `menu_item` VALUES (1,'User Interface',1,'',0,1,1);
...
INSERT INTO `ui_customization_setting` VALUES (2,2,'ldagulto@encorefinancials.com','true','true',NULL,'true',NULL,NULL,2),(3,1,'admin@encorefinancials.com','false','true','preset-8','false','false','false',1);
...
INSERT INTO `users` VALUES (1,'admin@encorefinancials.com','W5hvx4P278F8q50uZe2YFif%2ByRDeSeNaainzl5K9%2BQM%3D','Administrator','Active','2023-10-06',0,'2023-05-01 08:50:59','2023-05-01 13:07:21',1),(2,'ldagulto@encorefinancials.com','GgukHef0woUl4E8Dso5NUoA%2FW9Mnae5LVVBj6oPj8WQ%3D','Lawrence D. Agulto','Active','2023-10-11',5,'2023-05-01 08:42:36','2023-04-11 09:05:48',1);
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_menu_item`(IN p_menu_item_name VARCHAR(100), IN p_menu_group_id INT(10), IN p_menu_item_url VARCHAR(50), IN p_parent_id INT(10), IN p_order_sequence TINYINT(10), IN p_last_log_by INT(10), OUT p_menu_item_id INT(10))
BEGIN
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_menu_item`(IN p_menu_item_id INT(10), IN p_menu_item_name VARCHAR(100), IN p_menu_group_id INT(10), IN p_menu_item_url VARCHAR(50), IN p_parent_id INT(10), IN p_order_sequence TINYINT(10), IN p_last_log_by INT(10))
BEGIN
	UPDATE menu_item
...
-- Dump completed on 2023-05-01 19:46:34
