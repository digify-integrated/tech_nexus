...
INSERT INTO `menu_groups` VALUES (1,'Administrators',7,1);
...
INSERT INTO `ui_customization_setting` VALUES (2,2,'ldagulto@encorefinancials.com','true','true',NULL,'true',NULL,NULL,2),(3,1,'admin@encorefinancials.com','false',NULL,'preset-1','false',NULL,NULL,1);
...
INSERT INTO `users` VALUES (1,'admin@encorefinancials.com','W5hvx4P278F8q50uZe2YFif%2ByRDeSeNaainzl5K9%2BQM%3D','Administrator','Active','2023-10-06',0,'2023-04-18 15:14:13','2023-04-24 11:17:24',1),(2,'ldagulto@encorefinancials.com','GgukHef0woUl4E8Dso5NUoA%2FW9Mnae5LVVBj6oPj8WQ%3D','Lawrence D. Agulto','Active','2023-10-11',2,'2023-04-13 15:07:06','2023-04-11 09:05:48',1);
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_menu_item`(IN p_menu_item_name VARCHAR(100), IN p_menu_group_id INT(10), IN p_order_sequence TINYINT(10), IN p_last_log_by INT(10), OUT p_menu_item_id INT(10))
BEGIN
    INSERT INTO menu_item (menu_item_name, menu_group_id, order_sequence, last_log_by) 
	VALUES(p_menu_item_name, p_menu_group_id, p_order_sequence, p_last_log_by);
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_menu_item`(IN p_menu_item_id INT(10), IN p_menu_group_id INT(10), IN p_menu_item_name VARCHAR(100), IN p_order_sequence TINYINT(10), IN p_last_log_by INT(10))
BEGIN
	UPDATE menu_item
...
-- Dump completed on 2023-04-28 17:43:27
