<?php
    ...
    $chattelMortgageTable = generateChattelMortgageTable($fullStockNumber, $productDescription, $pnAmount);
    ...
    $pdf->Cell(152, 8, 'CHRISTIAN GENERAL MOTORS INCORPORATED'  , 0, 0, 'L');
    $pdf->Cell(32, 8, 'SERVICE INVOICE', 0, 0, 'L');
    $pdf->Ln(5);
    $pdf->SetFont('times', '', 9);
    $pdf->Cell(152, 8, 'Sta. Rosa Road, San Jose City of Tarlac 2300 Tarlac'  , 0, 0, 'L');
    ...
    $pdf->Ln(0);
    $pdf->SetFont('times', '', 9);
    $pdf->Cell(120, 8, '10 Bklts (2x) 0001-0500'  , 0, 0, 'L');
    $pdf->Cell(100, 8, '_________________________________________'  , 0, 0, 'L');
    $pdf->Ln(5);
    $pdf->Cell(120, 8, 'BIR Authority to Print No.'  , 0, 0, 'L');
    $pdf->SetFont('times', '', 10.5);
    $pdf->Cell(70, 8, 'Cashier/Authorized Representative'  , 0, 0, 'C');
    $pdf->Ln(5);
    $pdf->SetFont('times', '', 9);
    $pdf->Cell(120, 8, 'Date Issued:'  , 0, 0, 'L');
    $pdf->Ln(5);
    $pdf->SetFont('times', '', 9);
    $pdf->Cell(120, 8, 'Printer'. "'" .'s Accreditation No.'  , 0, 0, 'L');
    $pdf->Ln(5);
    $pdf->SetFont('times', '', 9);
    $pdf->Cell(120, 8, 'Date Issued:'  , 0, 0, 'L');
    ...
    function generateChattelMortgageTable($fullStockNumber, $productDescription, $pnAmount){
        ...
        $response = '<table border="0.5" width="100%" cellpadding="2" align="center">
                        <tbody>
                        <tr>
                            <td width="25%">Unit Number</td>
                            <td width="40%">Description</td>
                            <td width="13.5%">Qty</td>
                        ...
                        <tr align="left">
                            ...
                            <td colspan="2">Total Sales (VAT Inclusive)</td>
                            <td>'. number_format($pnAmount, 2) .'</td>
                        </tr>
                        <tr align="left">
