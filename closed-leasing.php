<?php
  ...
  $pageTitle = 'Closed Leasing';
    
  $leasingRepaymentReadAccess = $userModel->checkMenuItemAccessRights($user_id, 116, 'read');
  $leasingRepaymentCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 116, 'create');
  $leasingRepaymentWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 116, 'write');
  $leasingRepaymentDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 116, 'delete');
      ...
      <div class="pc-content">
        ...
        <?php
          if(!empty($leasingApplicationID) && empty($leasingApplicationRepaymentID)){
            ...
            require_once('view/_closed_leasing.php');
          }
        ?>
      </div>
    </section>
