...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
        ...
        <?php
          if($newRecord && $civilStatusCreateAccess['total'] > 0){
            require_once('view/_civil_status_new.php');
          }
          else if(!empty($civilStatusID) && $civilStatusWriteAccess['total'] > 0){
            require_once('view/_civil_status_details.php');
          }
          else{
            require_once('view/_civil_status.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/civil-status.js?v=<?php echo rand(); ?>"></script>
</body>
