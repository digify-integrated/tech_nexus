  ...
  <div class="col-lg-12">
    <div class="card">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
            <?php                            
              ...
              if ($branchDuplicateAccess['total'] > 0) {
                $dropdown .= '<li><button class="dropdown-item" type="button" id="duplicate-branch">Duplicate Branch</button></li>';
              }
                        
              if ($branchDeleteAccess['total'] > 0) {
                $dropdown .= '<li><button class="dropdown-item" type="button" id="delete-branch-details">Delete Branch</button></li>';
              }
              ...
              if ($branchWriteAccess['total'] > 0) {
                echo '<button type="submit" class="btn btn-info form-details" id="edit-form">Edit</button>
                      <button type="submit" form="branch-form" class="btn btn-success form-edit d-none" id="submit-data">Save</button>
                      <button type="button" id="discard-update" class="btn btn-outline-danger form-edit d-none">Discard</button>';
              }

              if ($branchCreateAccess['total'] > 0) {
                echo '<a class="btn btn-success m-r-5 form-details" href="branch.php?new">Create</a>';
              }
            ?>
          </div>
        </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
            <form id="branch-form" method="post" action="#">
              <?php
                if($branchWriteAccess['total'] > 0){
                  echo '<div class="form-group row">
                          <label class="col-lg-2 col-form-label">Name <span class="text-danger d-none form-edit">*</span></label>
                          <div class="col-lg-4">
                            <label class="col-form-label form-details fw-normal" id="branch_name_label"></label>
                            <input type="text" class="form-control d-none form-edit" id="branch_name" name="branch_name" maxlength="100" autocomplete="off">
                          </div>
        ...
        <div class="card">
          ...
          <div class="log-notes-scroll" style="max-height: 450px; position: relative;">
            <div class="card-body p-b-0">
              '. $userModel->generateLogNotes('branch', $branchID) .'
            </div>
          </div>
        </div>
      </div>';
