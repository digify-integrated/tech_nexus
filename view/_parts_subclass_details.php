        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
            <?php                            
                ...
                if ($partsSubclassDuplicateAccess['total'] > 0) {
                    $dropdown .= '<li><button class="dropdown-item" type="button" id="duplicate-parts-subclass">Duplicate Part Subclass</button></li>';
                }
                            
                if ($partsSubclassDeleteAccess['total'] > 0) {
                    $dropdown .= '<li><button class="dropdown-item" type="button" id="delete-parts-subclass-details">Delete Part Subclass</button></li>';
                }
                ...
                if ($partsSubclassWriteAccess['total'] > 0) {
                    echo '<button type="submit" class="btn btn-info form-details" id="edit-form">Edit</button>
                        <button type="submit" form="parts-subclass-form" class="btn btn-success form-edit d-none" id="submit-data">Save</button>
                        <button type="button" id="discard-update" class="btn btn-outline-danger form-edit d-none">Discard</button>';
                }

                if ($partsSubclassCreateAccess['total'] > 0) {
                    echo '<a class="btn btn-success m-r-5 form-details" href="parts-subclass.php?new">Create</a>';
                }
            ?>
          </div>
        </div>
                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="d-none form-edit">
                          <select class="form-control select2" name="parts_class_id" id="parts_class_id">
                            <option value="">--</option>
                            '. $partsClassModel->generatePartsClassOptions() .'
                          </select>
                        </div>
                      </div>
                    </div>';
          ...
          <div class="card">
            ...
            <div class="log-notes-scroll" style="max-height: 450px; position: relative;">
              <div class="card-body p-b-0">
                '. $userModel->generateLogNotes('parts_subclass', $partsSubclassID) .'
              </div>
            </div>
          </div>
        </div>';
