    ...
    <div class="card">
      <div class="card-header">
        <div class="row align-items-center">
          ...
          <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
            <?php
                if($districtCreateAccess['total'] > 0 || $districtDeleteAccess['total'] > 0){
                $action = ' ';
                ...
                if($districtDeleteAccess['total'] > 0){
                    $action .= '<div class="btn-group m-r-10">
                                <button type="button" class="btn btn-outline-secondary dropdown-toggle d-none action-dropdown" data-bs-toggle="dropdown" aria-expanded="false">Action</button>
                                    ...
                                    <li><button class="dropdown-item" type="button" id="delete-district">Delete District</button></li>
                                    </ul>
                                    </div>';
                }

                if($districtCreateAccess['total'] > 0){
                    $action .= '<a href="district.php?new" class="btn btn-success">Create</a>';
                }
      ...
      <div class="card-body">
        <div class="table-responsive dt-responsive">
          <table id="district-table" class="table table-striped table-hover table-bordered nowrap w-100">
            <thead>
              <tr>
                <th class="all">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filter-canvas" aria-labelledby="filter-canvas-label">
  ...
  <div class="offcanvas-body">
    <div class="form-group mb-4">
      ...
      <select class="form-control filter-select2" name="filter_city" id="filter_city">
        <option value="">--</option>
