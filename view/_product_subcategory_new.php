          ...
          <?php
            if ($productSubcategoryCreateAccess['total'] > 0) {
               echo '<div class="col-md-6 text-sm-end mt-3 mt-sm-0">
                      <button type="submit" form="product-subcategory-form" class="btn btn-success form-edit" id="submit-data">Save</button>
      ...
      <div class="card-body">
        <form id="product-subcategory-form" method="post" action="#">
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" id="product_subcategory_name" name="product_subcategory_name" maxlength="100" autocomplete="off">
            </div>
            <label class="col-lg-2 col-form-label">Code <span class="text-danger">*</span></label>
            <div class="col-lg-4">
              <input type="text" class="form-control" id="product_subcategory_code" name="product_subcategory_code" maxlength="50" autocomplete="off">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              <select class="form-control select2" name="product_category_id" id="product_category_id">
                <option value="">--</option>
                <?php echo $productCategoryModel->generateProductCategoryOptions(); ?>
               </select>
            </div>
          </div>
        </form>
