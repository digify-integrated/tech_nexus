                      ...
                      <li class="list-group-item px-0 py-2">
                        ...
                        <div class="collapse show" id="transmittal-status-filter-collapse">
                          <div class="py-3">
                            ...
                            <div class="form-check my-2">
                                <input class="form-check-input transmittal-status-filter" type="checkbox" id="transmittal-status-transmitted" value="Transmitted" checked>
                                <label class="form-check-label" for="transmittal-status-transmitted">Transmitted</label>
                            </div>
                            <div class="form-check my-2">
                                <input class="form-check-input transmittal-status-filter" type="checkbox" id="transmittal-status-retransmitted" value="Re-Transmitted" checked>
