                  ...
                  <div class="collapse" id="request-status-filter-collapse">
                    <div class="row py-3">
                      <div class="col-12">
                        ...
                        <div class="form-check my-2">
                          <input class="form-check-input request-status-checkbox" type="checkbox" id="request-status-released" value="Released"/>
                          <label class="form-check-label" for="request-status-released">Released</label>
                        </div>
                        <div class="form-check my-2">
