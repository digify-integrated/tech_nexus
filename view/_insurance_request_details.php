        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
            <?php                            
                ...
                if($status == 'Submitted'){
                    $dropdown .= '<li><button class="dropdown-item" type="button" id="received">Received</button></li>';
                }

                if($status == 'For Submission' || $status == 'Submitted'){
                    $dropdown .= '<li><button class="dropdown-item" type="button" id="draft">Draft</button></li>';
                }
