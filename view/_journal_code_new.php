      ...
      <div class="card-body">
        <form id="journal-code-form" method="post" action="#">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-4">
              <input type="text" class="form-control" id="debit" name="debit" maxlength="500" autocomplete="off">
            </div>
            <label class="col-lg-2 col-form-label">Credit <span class="text-danger">*</span></label>
            <div class="col-lg-4">
              <input type="text" class="form-control" id="credit" name="credit" maxlength="500" autocomplete="off">
            </div>
          </div>
        </form>
      </div>
