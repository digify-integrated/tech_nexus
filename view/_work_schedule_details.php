  ...
  if(!empty($workScheduleID)){
    if($addWorkingHours['total'] > 0){
      if($workScheduleTypeID == 1){
        ...
        $workingHoursTable = '<table id="fixed-working-hours-table" class="table table-hover nowrap w-100 dataTable">
                                  <thead>
                                    <tr>
                                      <th>Day of Week</th>
                                      <th>Day Period</th>
        ...
        $workingHoursTable = '<table id="flexible-working-hours-table" class="table table-hover nowrap w-100 dataTable">
                                  <thead>
                                    <tr>
                                      <th>Work Date</th>
                                      <th>Day Period</th>
