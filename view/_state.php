                  ...
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item px-0 py-2">
                        <a class="btn border-0 px-0 text-start w-100" data-bs-toggle="collapse" href="#country-filter-collapse"><div class="float-end"><i class="ti ti-chevron-down"></i></div>
                          Country
                        </a>
                        <div class="collapse show" id="country-filter-collapse">
                          <div class="py-3">
                            <?php
                              echo $countryModel->generateCountryCheckBox();
                            ?>
                          </div>
                        </div>
                      </li>
        ...
        <div class="card table-card">
          ...
          <div class="card-body">
            <div class="table-responsive dt-responsive">
              <table id="state-table" class="table table-hover nowrap w-100">
                <thead>
                  <tr>
                    <th class="all">
