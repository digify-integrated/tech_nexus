          ...
          <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
            <?php
              ...
              if ($fileExtensionDuplicateAccess['total'] > 0) {
                $dropdown .= '<li><button class="dropdown-item" type="button" id="duplicate-file-extension">Duplicate File Extension</button></li>';
              }
                        
              if ($fileExtensionDeleteAccess['total'] > 0) {
                $dropdown .= '<li><button class="dropdown-item" type="button" id="delete-file-extension-details">Delete File Extension</button></li>';
              }
        ...
        <?php
          if($fileExtensionWriteAccess['total'] > 0){
            echo '<div class="form-group row">
                    ...
                    <div class="col-lg-4">
                      <label class="col-form-label form-details fw-normal" id="file_type_id_label"></label>
