                  ...
                  <div class="card-body">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item px-0 py-2 d-none">
                        ...
                        <div class="collapse " id="payment-details-filter-collapse">
                          <div class="row py-3">
                            <div class="col-12">
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-acct-amort" value="Acct Amort"/>
                                  <label class="form-check-label" for="payment-details-acct-amort">Acct Amort</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-acct-amort-w-oc" value="Acct Amort W/ OC"/>
                                  <label class="form-check-label" for="payment-details-acct-amort-w-oc">Acct Amort W/ OC</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-advances" value="Advances"/>
                                  <label class="form-check-label" for="payment-details-advances">Advances</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-collateral-check" value="Collateral Check"/>
                                  <label class="form-check-label" for="payment-details-collateral-check">Collateral Check</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-deposit" value="Deposit">
                                  <label class="form-check-label" for="payment-details-deposit">Deposit</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-downpayment" value="Downpayment">
                                  <label class="form-check-label" for="payment-details-downpayment">Downpayment</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-insurance" value="Insurance">
                                  <label class="form-check-label" for="payment-details-insurance">Insurance</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-insurance-renewal" value="Insurance Renewal">
                                  <label class="form-check-label" for="payment-details-insurance-renewal">Insurance Renewal</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-other-charges" value="Other Charges">
                                  <label class="form-check-label" for="payment-details-other-charges">Other Charges</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-additional-job-order" value="Additional Job Order">
                                  <label class="form-check-label" for="payment-details-additional-job-order">Additional Job Order</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-parts" value="Parts">
                                  <label class="form-check-label" for="payment-details-parts">Parts</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-registration" value="Registration">
                                  <label class="form-check-label" for="payment-details-registration">Registration</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-registration-renewal" value="Registration Renewal">
                                  <label class="form-check-label" for="payment-details-registration-renewal">Registration Renewal</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-transaction-fee" value="Transaction Fee">
                                  <label class="form-check-label" for="payment-details-transaction-fee">Transaction Fee</label>
                              </div>
                              <div class="form-check my-2">
                                  <input class="form-check-input payment-details-filter" type="checkbox" id="payment-details-transfer-fee" value="Transfer Fee">
