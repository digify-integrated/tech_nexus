                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item px-0 py-2">
                        ...
                        <div class="collapse show" id="city-filter-collapse">
                          <div class="py-3">
                            <?php
                              echo $cityModel->generateCityCheckBox('warehouse');
                            ?>
                          </div>
                        </div>
                      </li>
        ...
        <div class="card table-card">
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                <?php
                  if($warehouseCreateAccess['total'] > 0 || $warehouseDeleteAccess['total'] > 0){
                    $action = ' ';
                    ...
                    if($warehouseDeleteAccess['total'] > 0){
                      $action .= '<div class="btn-group m-r-10">
                                          ...
                                          <ul class="dropdown-menu dropdown-menu-end">
                                              <li><button class="dropdown-item" type="button" id="delete-warehouse">Delete Warehouse</button></li>
                                          </ul>
                                      </div>';
                    }

                    if($warehouseCreateAccess['total'] > 0){
                      $action .= '<a href="warehouse.php?new" class="btn btn-success">Create</a>';
                    }
          ...
          <div class="card-body">
            <div class="table-responsive dt-responsive">
              <table id="warehouse-table" class="table table-hover nowrap w-100">
                <thead>
                  <tr>
                    <th class="all">
