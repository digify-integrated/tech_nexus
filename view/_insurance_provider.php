                    ...
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item px-0 py-2">
                        ...
                        <div class="collapse show" id="city-filter-collapse">
                          <div class="py-3">
                            <?php
                              echo $cityModel->generateCityCheckBox('insurance-provider');
                            ?>
                          </div>
                        </div>
                      </li>
                      <li class="list-group-item px-0 py-2">
                        <button type="button" class="btn btn-light-success w-100" id="apply-filter">Apply</button>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="card table-card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-sm-6">
                <h5>Insurance Provider List</h5>
              </div>
              <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                <?php
                  if($insuranceProviderCreateAccess['total'] > 0 || $insuranceProviderDeleteAccess['total'] > 0){
                    $action = '';
                    ...
                    if($insuranceProviderDeleteAccess['total'] > 0){
                      $action .= '<div class="btn-group m-r-10">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                      <li><button class="dropdown-item" type="button" id="delete-insurance-provider">Delete Insurance Provider</button></li>
                                    </ul>
                                  </div>';
                    }

                    if($insuranceProviderCreateAccess['total'] > 0){
                      $action .= '<a href="insurance-provider.php?new" class="btn btn-success">Create</a>';
                    }
          ...
          <div class="card-body">
            <div class="table-responsive dt-responsive">
              <table id="insurance-provider-table" class="table table-hover nowrap w-100">
                <thead>
                  <tr>
                    <th class="all">
