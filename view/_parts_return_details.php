<?php
    ...
    $number_of_items = $partReturnDetails['number_of_items'] ?? 0;
          ...
          <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
            <?php                            
                ...
                if ($partsReturnDeleteAccess['total'] > 0) {
                  $dropdown .= '<li><button class="dropdown-item" type="button" id="delete-parts-return-details">Delete '. $cardLabel .' Return</button></li>';
                }
                ...
                if($part_return_status == 'For Approval'){
                  $dropdown .= '<li><button class="dropdown-item" type="button" id="on-process">Approve</button></li>';
                }

                if($part_return_status == 'Completed' && $postPartsReturn['total'] > 0){
                  $dropdown .= '<li><button class="dropdown-item" type="button" id="post">Post</button></li>';
                }

                if($part_return_status == 'Posted'){
                   $dropdown .= '<li><a href="parts-return-receiving-report.php?id='. $partsReturnID .'" class="dropdown-item"  target="_blank">Print Receiving Report</a></li>';
                }

                if($part_return_status == 'Draft' || $part_return_status == 'For Approval' || $part_return_status == 'On-Process'){
                  $dropdown .= '<li><button class="dropdown-item" type="button" data-bs-toggle="offcanvas" data-bs-target="#cancel-return-offcanvas" aria-controls="cancel-return-offcanvas" id="cancelled">Cancel</button></li>';
                }

                if($part_return_status == 'For Approval' || $part_return_status == 'On-Process'){
                  $dropdown .= '<li><button class="dropdown-item" type="button" data-bs-toggle="offcanvas" data-bs-target="#draft-return-offcanvas" aria-controls="draft-return-offcanvas" id="draft">Set to Draft</button></li>';
                }

                if($releaseReturnParts['total'] > 0 && $part_return_status == 'On-Process'){
                  $dropdown .= '<li><button class="dropdown-item" type="button" data-bs-toggle="offcanvas" data-bs-target="#release-return-offcanvas" aria-controls="release-return-offcanvas">Complete</button></li>';
                }

                if($part_return_status == 'On-Process' || $part_return_status == 'Completed' || $part_return_status == 'Posted'){
                   $dropdown .= '<li><a href="parts-return-purchase-order.php?id='. $partsReturnID .'" class="dropdown-item"  target="_blank">Print Purchase Order</a></li>';
                }
                ...
                if ($partsReturnWriteAccess['total'] > 0 && $part_return_status == 'Draft') {
                    echo '<button type="submit" form="parts-return-form" class="btn btn-success me-2" id="submit-data">Save</button>';
                }
  ...
  <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5>Return Document</h5>
                </div>
                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                    <?php
                      if($part_return_status != 'Released'){
        ...
        <div class="card-body p-0">
            <div class="dt-responsive table-responsive">
                <table class="table mb-0" id="parts-return-document-table">
                    <thead>
                        <tr>
          ...
          <form id="add-part-document-form" method="post" action="#">
            ...
            <div class="form-group row">
              <div class="col-lg-12 mt-3 mt-lg-0">
                ...
                <input type="file" id="return_document" name="return_document" class="form-control">
              </div>
            </div>
          </form>
        </div>
...
<div>
  <div class="offcanvas offcanvas-end" tabindex="-1" id="release-return-offcanvas" aria-labelledby="release-return-offcanvas-label">
      <div class="offcanvas-header">
        <h2 id="release-return-offcanvas-label" style="margin-bottom:-0.5rem">Complete Return</h2>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
    <div class="offcanvas-body">
      <div class="row">
        <div class="col-lg-12">
          <form id="release-return-form" method="post" action="#">
            <div class="form-group row">
              <div class="col-lg-12 mt-3 mt-lg-0"> 
      ...
      <div class="row">
        <div class="col-lg-12">
          <button type="submit" class="btn btn-primary" id="submit-release-return" form="release-return-form">Submit</button>
          <button class="btn btn-light-danger" data-bs-dismiss="offcanvas"> Close </button>
        </div>
      </div>
  </div>
