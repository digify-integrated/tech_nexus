    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <li><a class="nav-link" id="leasing-application-tab-4" data-bs-toggle="pill" href="#v-summary" role="tab" aria-controls="v-summary" aria-selected="false" disabled>Repayment Schedule</a></li>
        </ul>
      </div>
    </div>
  </div>
              ...
              <?php
                ...
                if($applicationStatus == 'Approved'){
                  echo '<div class="previous me-2" id="generate-schedule-button">
                        ...
                        if($activateLeasingApplication['total'] > 0 && $leasingRepaymentCount['total'] > 0){
                          echo '<div class="previous me-2" id="leasing-application-activation-button">
                          <button class="btn btn-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#leasing-application-activation-offcanvas" aria-controls="leasing-application-activation-offcanvas" id="leasing-application-activation">Activate</button>
                        </div>';
                        }
                }

                if($setToDraftLeasingApplication['total'] > 0 && ($applicationStatus != 'Active' && $applicationStatus != 'Draft')){
                  echo '<div class="previous me-2" id="leasing-application-set-to-draft-button">
                          <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#leasing-application-set-to-draft-offcanvas" aria-controls="leasing-application-set-to-draft-offcanvas" id="leasing-application-set-to-draft">Draft</button>
                      </div>';
                }
               
                if($applicationStatus == 'Draft' && $forInitialApproval['total'] > 0){
                  echo '<div class="previous me-2" id="tag-for-approval-button">
                          <button class="btn btn-primary" id="tag-for-approval">For Approval</button>
                        </div>';
                }

                if($applicationStatus == 'For Approval' && $approveLeasingApplication['total'] > 0){
                  echo '<div class="previous me-2" id="leasing-application-approval-button">
                ...
                if($applicationStatus == 'For Approval' && $rejectLeasingApplication['total'] > 0){
                    echo '<div class="previous me-2" id="leasing-application-reject-button">
                ...
                if($applicationStatus == 'Draft' && $cancelLeasingApplication['total'] > 0){
                  echo '<div class="previous me-2" id="leasing-application-cancel-button">
          ...
          <div class="tab-pane" id="v-summary">
            <div class="table-responsive">
              <table class="table table-hover nowrap w-100">
                ...
                <tbody id="repayment-table"></tbody>
              </table>
            </div>
          </div>
        </div>
