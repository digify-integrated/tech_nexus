    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <li><a class="nav-link" id="sales-proposal-tab-11" data-bs-toggle="pill" href="#v-confirmations" role="tab" aria-controls="v-confirmations" aria-selected="false" <?php echo $disabled; ?>>Confirmations</a></li>
          <li><a class="nav-link" id="sales-proposal-tab-12" data-bs-toggle="pill" href="#v-summary" role="tab" aria-controls="v-summary" aria-selected="false" <?php echo $disabled; ?>>Summary</a></li>
        </ul>
      </div>
    </div>
  </div>
            ...
            <div class="d-flex">
              <?php
                ...
                if($salesProposalStatus == 'For Final Approval' || $salesProposalStatus == 'For CI' || $salesProposalStatus == 'For Initial Approval' || $salesProposalStatus == 'Draft'){
                  echo '<div class="previous me-2 d-none" id="sales-proposal-client-confirmation-button">
                          <button class="btn btn-success me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sales-proposal-client-confirmation-offcanvas" aria-controls="sales-proposal-client-confirmation-offcanvas" id="sales-proposal-client-confirmation">Client Confirmation</button>
                        </div>';

                  echo '<div class="previous me-2 d-none" id="sales-proposal-new-engine-stencil-button">
                          <button class="btn btn-info me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sales-proposal-new-engine-stencil-offcanvas" aria-controls="sales-proposal-new-engine-stencil-offcanvas" id="sales-proposal-new-engine-stencil">New Engine Stencil</button>
                        </div>';

                  if(!empty($clientConfirmation) && $transactionType == 'Bank Financing'){
                    echo '<div class="previous me-2 d-none" id="sales-proposal-credit-advice-button">
                            <button class="btn btn-warning me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sales-proposal-credit-advice-offcanvas" aria-controls="sales-proposal-credit-advice-offcanvas" id="sales-proposal-credit-advice">Credit Advice</button>
                          </div>';
                  }
                }
                ...
                if($salesProposalStatus == 'Ready For Release'){
                  if($tagSalesProposalForDR['total'] > 0){
                    echo '<div class="previous me-2 d-none" id="for-dr-sales-proposal-button">
                            <button class="btn btn-success m-l-5" id=" ">For DR</button>
                        </div>';
                  }
                }
