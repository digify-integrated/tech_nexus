        ...
        <div class="tab-content">
          <div class="d-flex wizard justify-content-between mb-3">
            ...
            <div class="d-flex">
              <?php
                ...
                if($salesProposalStatus == 'Ready For Release' || (($salesProposalStatus == 'Proceed' || $salesProposalStatus == 'On-Process') && ($productType == 'Refinancing' || $productType == 'Brand New' || $productType == 'Fuel' || $productType == 'Parts'))){
          ...
          <div class="tab-pane" id="v-refinancing-details">
            <form id="sales-proposal-refinancing-details-form" method="post" action="#">
              ...
              <div class="form-group row">
                <label class="col-lg-4 col-form-label">Received From ID Number : </label>
                <div class="col-lg-8">
