                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
                        <?php                            
                            ...
                            if ($ciReportWriteAccess['total'] > 0) {
            ...
            <div class="card-body">
                <form id="ci-report-form" method="post" action="#">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control select2" name="appraiser" id="appraiser">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            <select class="form-control select2" name="investigator" id="investigator">
                                <option value="">--</option>
                                <?php echo $userModel->generateCIInvestigatorOptions('active'); ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" id="narrative_summary" name="narrative_summary" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="row">
  <div class="col-lg-12">
    <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation"><button class="nav-link" id="summary" data-bs-toggle="tab" data-bs-target="#summary-pane" type="button" role="tab" aria-controls="summary-pane" aria-selected="false" tabindex="-1">Summary</button></li>
    </ul>
    <div class="tab-content" id="ciTabContent">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-residence-modal" id="add-ci-report-residence">Add Residence</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-dependents-modal" id="add-ci-report-dependents">Add Dependents</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-business-modal" id="add-ci-report-business">Add Business</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-employment-modal" id="add-ci-report-employment">Add Employment</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-bank-modal" id="add-ci-report-bank">Add Bank</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-loan-modal" id="add-ci-report-loan">Add Loan</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-asset-modal" id="add-ci-report-asset">Add Asset</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-cmap-modal" id="add-ci-report-cmap">Add CMAP</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card table-card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-collateral-modal" id="add-ci-report-collateral">Add Collateral</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <div class="tab-pane fade" id="summary-pane" role="tabpanel" aria-labelledby="summary" tabindex="0">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card table-card">
                        <div class="card-header">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-residence-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_residence_contact_address" name="ci_residence_contact_address" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_residence_city_id">City <span class="text-danger">*</span></label>
                            <select class="form-control select2" name="ci_residence_city_id" id="ci_residence_city_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_residence_prev_address" name="ci_residence_prev_address" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_residence_prev_city_id">Previous City</label>
                            <select class="form-control select2" name="ci_residence_prev_city_id" id="ci_residence_prev_city_id">
                                <option value="">--</option>
                                <?php echo $cityModel->generateCityOptions() ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="ci_residence_length_stay_year" name="ci_residence_length_stay_year" min="0" step="1">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_residence_length_stay_month">Length Stay (Month)</label>
                            <input type="number" class="form-control" id="ci_residence_length_stay_month" name="ci_residence_length_stay_month" min="0" step="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_residence_residence_type_id" id="ci_residence_residence_type_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_residence_rented_from" name="ci_residence_rented_from" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_rent_amount">Rent Amount</label>
                            <input type="number" class="form-control" id="ci_residence_rent_amount" name="ci_residence_rent_amount" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_estimated_value">Estimated Value</label>
                            <input type="number" class="form-control" id="ci_residence_estimated_value" name="ci_residence_estimated_value" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_structure_type_id">Structure Type</label>
                            <select class="form-control select2" name="ci_residence_structure_type_id" id="ci_residence_structure_type_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="number" class="form-control" id="ci_residence_residence_age" name="ci_residence_residence_age" min="0" step="1">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_building_make_id">Building Make</label>
                            <select class="form-control select2" name="ci_residence_building_make_id" id="ci_residence_building_make_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="number" class="form-control" id="ci_residence_lot_area" name="ci_residence_lot_area" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_floor_area">Floor Area (SQM)</label>
                            <input type="number" class="form-control" id="ci_residence_floor_area" name="ci_residence_floor_area" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_furnishing_appliance">Furnishing Appliance</label>
                            <textarea class="form-control" id="ci_residence_furnishing_appliance" name="ci_residence_furnishing_appliance" maxlength="3000" rows="3"></textarea>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_vehicle_owned">Vehicle Owned</label>
                            <textarea class="form-control" id="ci_residence_vehicle_owned" name="ci_residence_vehicle_owned" maxlength="3000" rows="3"></textarea>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_real_estate_owned">Real Estate Owned</label>
                            <textarea class="form-control" id="ci_residence_real_estate_owned" name="ci_residence_real_estate_owned" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_residence_neighborhood_type_id" id="ci_residence_neighborhood_type_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_residence_accessible_to" name="ci_residence_accessible_to" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_nearest_corner">Nearest Corner</label>
                            <input type="text" class="form-control" id="ci_residence_nearest_corner" name="ci_residence_nearest_corner" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_residence_income_level_id" id="ci_residence_income_level_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_residence_informant" name="ci_residence_informant" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_informant_address">Informant Address</label>
                            <input type="text" class="form-control" id="ci_residence_informant_address" name="ci_residence_informant_address" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="number" class="form-control" id="ci_residence_personal_expense" name="ci_residence_personal_expense" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_utilities_expense">Utilities Expense</label>
                            <input type="number" class="form-control" id="ci_residence_utilities_expense" name="ci_residence_utilities_expense" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_residence_other_expense">Other Expense</label>
                            <input type="number" class="form-control" id="ci_residence_other_expense" name="ci_residence_other_expense" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_residence_remarks" name="ci_residence_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="submit-ci-residence" form="ci-residence-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-dependents-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <form id="ci-dependents-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_dependents_name" name="ci_dependents_name" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_dependents_age">Age</label>
                            <input type="number" class="form-control" id="ci_dependents_age" name="ci_dependents_age" min="0" step="1">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_dependents_school">School</label>
                            <input type="text" class="form-control" id="ci_dependents_school" name="ci_dependents_school" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_dependents_employment">Employment</label>
                            <input type="text" class="form-control" id="ci_dependents_employment" name="ci_dependents_employment" maxlength="500" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-label" for="ci_dependents_remarks">Remarks</label>
                            <textarea class="form-control" id="ci_dependents_remarks" name="ci_dependents_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-dependents" form="ci-dependents-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-business-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-business-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_business_business_name" name="ci_business_business_name" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_business_description">Description <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_business_description" name="ci_business_description" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_business_contact_address">Address <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_business_contact_address" name="ci_business_contact_address" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_business_city_id">City <span class="text-danger">*</span></label>
                            <select class="form-control select2" name="ci_business_city_id" id="ci_business_city_id">
                                <option value="">--</option>
                                <?php echo $cityModel->generateCityOptions() ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="ci_business_length_stay_year" name="ci_business_length_stay_year" min="0" step="1">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_business_length_stay_month">Length Stay (Month)</label>
                            <input type="number" class="form-control" id="ci_business_length_stay_month" name="ci_business_length_stay_month" min="0" step="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_business_registered_with" name="ci_business_registered_with" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_organization">Organization</label>
                            <input type="text" class="form-control" id="ci_business_organization" name="ci_business_organization" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_date_organized">Registered With</label>
                            <input type="text" class="form-control" id="ci_business_date_organized" name="ci_business_date_organized" maxlength="100" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_no_employee">No. Employees</label>
                            <input type="number" class="form-control" id="ci_business_no_employee" name="ci_business_no_employee" min="0" step="1">
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_business_major_bank_id" id="ci_business_major_bank_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_business_contact_person" name="ci_business_contact_person" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_business_business_location_type_id" id="ci_business_business_location_type_id">
                                <option value="">--</option>
                                <?php echo $businessLocationTypeModel->generateBusinessLocationTypeOptions() ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_building_make_id">Business Location</label>
                            <select class="form-control select2" name="ci_business_building_make_id" id="ci_business_building_make_id">
                                <option value="">--</option>
                                <?php echo $buildingMakeModel->generateBuildingMakeOptions() ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_business_business_premises_id" id="ci_business_business_premises_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_business_landlord" name="ci_business_landlord" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_rental_amount">Rental</label>
                            <input type="number" class="form-control" id="ci_business_rental_amount" name="ci_business_rental_amount" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_machineries">Machineries</label>
                            <input type="text" class="form-control" id="ci_business_machineries" name="ci_business_machineries" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_fixtures">Fixtures</label>
                            <input type="number" class="form-control" id="ci_business_fixtures" name="ci_business_fixtures" min="0" step="0.01">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_facility_condition">Facility Condition</label>
                           <select class="form-control select2" name="ci_business_facility_condition" id="ci_business_facility_condition">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <textarea class="form-control" id="ci_business_branches" name="ci_business_branches" maxlength="3000" rows="3"></textarea>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_vehicle">Vehicle</label>
                            <textarea class="form-control" id="ci_business_vehicle" name="ci_business_vehicle" maxlength="3000" rows="3"></textarea>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_business_trade_reference">Trade Reference</label>
                            <textarea class="form-control" id="ci_business_trade_reference" name="ci_business_trade_reference" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <input type="number" class="form-control" id="ci_business_gross_monthly_sale" name="ci_business_gross_monthly_sale" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_monthly_income">Monthly Income</label>
                            <input type="number" class="form-control" id="ci_business_monthly_income" name="ci_business_monthly_income" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_inventory">Inventory</label>
                            <input type="number" class="form-control" id="ci_business_inventory" name="ci_business_inventory" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_receivable">Receivable</label>
                            <input type="number" class="form-control" id="ci_business_receivable" name="ci_business_receivable" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_fixed_asset">Fixed Asset</label>
                            <input type="number" class="form-control" id="ci_business_fixed_asset" name="ci_business_fixed_asset" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_liabilities">Liabilities</label>
                            <input type="number" class="form-control" id="ci_business_liabilities" name="ci_business_liabilities" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_business_capital">Capital</label>
                            <input type="number" class="form-control" id="ci_business_capital" name="ci_business_capital" min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_business_remarks" name="ci_business_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-business" form="ci-business-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-employment-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-employment-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_employment_employment_name" name="ci_employment_employment_name" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_description">Description <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_employment_description" name="ci_employment_description" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_contact_address">Address <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_employment_contact_address" name="ci_employment_contact_address" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_city_id">City <span class="text-danger">*</span></label>
                            <select class="form-control select2" name="ci_employment_city_id" id="ci_employment_city_id">
                                <option value="">--</option>
                                <?php echo $cityModel->generateCityOptions() ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_employment_department" name="ci_employment_department" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_rank">Rank</label>
                            <input type="text" class="form-control" id="ci_employment_rank" name="ci_employment_rank" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_position">Position</label>
                            <input type="text" class="form-control" id="ci_employment_position" name="ci_employment_position" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_status">Status</label>
                            <input type="text" class="form-control" id="ci_employment_status" name="ci_employment_status" maxlength="100" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="ci_employment_length_stay_year" name="ci_employment_length_stay_year" min="0" step="1">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_length_stay_month">Length Stay (Month)</label>
                            <input type="number" class="form-control" id="ci_employment_length_stay_month" name="ci_employment_length_stay_month" min="0" step="1">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_pres_length_stay_year">Present Position (Year)</label>
                            <input type="number" class="form-control" id="ci_employment_pres_length_stay_year" name="ci_employment_pres_length_stay_year" min="0" step="1">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_pres_length_stay_month">Present Position (Month)</label>
                            <input type="number" class="form-control" id="ci_employment_pres_length_stay_month" name="ci_employment_pres_length_stay_month" min="0" step="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_employment_informant" name="ci_employment_informant" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_employment_informant_address">Informant Address</label>
                            <input type="text" class="form-control" id="ci_employment_informant_address" name="ci_employment_informant_address" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <input type="number" class="form-control" id="ci_employment_net_salary" name="ci_employment_net_salary" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_employment_commission">Commission</label>
                            <input type="number" class="form-control" id="ci_employment_commission" name="ci_employment_commission" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_employment_allowance">Allowance</label>
                            <input type="number" class="form-control" id="ci_employment_allowance" name="ci_employment_allowance" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_employment_other_income">Other Income</label>
                            <input type="number" class="form-control" id="ci_employment_other_income" name="ci_employment_other_income" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_employment_remarks" name="ci_employment_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-employment" form="ci-employment-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-bank-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-bank-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_bank_bank_id" id="ci_bank_bank_id">
                                <option value="">--</option>
                                <?php echo $bankModel->generateBankOptions() ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_bank_bank_account_type_id" id="ci_bank_bank_account_type_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" id="ci_bank_account_name" name="ci_bank_account_name" maxlength="500" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_bank_account_number">Account Number <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_bank_account_number" name="ci_bank_account_number" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_bank_currency_id">Currency</label>
                            <select class="form-control select2" name="ci_bank_currency_id" id="ci_bank_currency_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-control select2" name="ci_bank_bank_handling_type_id" id="ci_bank_bank_handling_type_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_bank_date_open" name="ci_bank_date_open" autocomplete="off">
                        ...
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_bank_bank_adb">ADB</label>
                            <select class="form-control select2" name="ci_bank_bank_adb" id="ci_bank_bank_adb">
                                <option value="">--</option>
                            </select>
                        </div>
                        <div class="col-lg-4">
                            <label class="form-label" for="ci_bank_informant">Informant</label>
                            <input type="text" class="form-control" id="ci_bank_informant" name="ci_bank_informant" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_bank_remarks" name="ci_bank_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center deposit-hide d-none">
                        ...
                        <div class="col-sm-6 text-sm-end mb-3">
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-bank-deposits-modal" id="add-ci-report-bank-deposits">Add Deposits</button>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-bank" form="ci-bank-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-loan-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-loan-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_loan_company" name="ci_loan_company" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_informant">Informant</label>
                            <input type="text" class="form-control" id="ci_loan_informant" name="ci_loan_informant" maxlength="500" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_account_name">Account Name</label>
                            <input type="text" class="form-control" id="ci_loan_account_name" name="ci_loan_account_name" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_loan_type_id">Loan Type</label>
                            <select class="form-control select2" name="ci_loan_loan_type_id" id="ci_loan_loan_type_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_loan_availed_date" name="ci_loan_availed_date" autocomplete="off">
                                <span class="input-group-text">
                                    <i class="feather icon-calendar"></i>
                                </span>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_loan_maturity_date" name="ci_loan_maturity_date" autocomplete="off">
                                <span class="input-group-text">
                                    <i class="feather icon-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="ci_loan_term" name="ci_loan_term" min="0" step="1">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_pn_amount">PN Amount</label>
                            <input type="number" class="form-control" id="ci_loan_pn_amount" name="ci_loan_pn_amount" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_outstanding_balance">Outstanding Balance</label>
                            <input type="number" class="form-control" id="ci_loan_outstanding_balance" name="ci_loan_outstanding_balance" min="0" step="0.01">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_repayment">Repayment</label>
                            <input type="number" class="form-control" id="ci_loan_repayment" name="ci_loan_repayment" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_loan_handling">Handling</label>
                            <select class="form-control select2" name="ci_loan_handling" id="ci_loan_handling">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_loan_remarks" name="ci_loan_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-loan" form="ci-loan-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-asset-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <form id="ci-asset-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <select class="form-control select2" name="ci_asset_asset_type_id" id="ci_asset_asset_type_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_asset_description" name="ci_asset_description" maxlength="500" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_asset_value">Value</label>
                            <input type="number" class="form-control" id="ci_asset_value" name="ci_asset_value" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-label" for="ci_asset_remarks">Remarks</label>
                            <textarea class="form-control" id="ci_asset_remarks" name="ci_asset_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-asset" form="ci-asset-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-cmap-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <form id="ci-cmap-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <select class="form-control select2" name="ci_cmap_cmap_report_type_id" id="ci_cmap_cmap_report_type_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_cmap_defendant" name="ci_cmap_defendant" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_plaintiff">Plaintiff <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ci_cmap_plaintiff" name="ci_cmap_plaintiff" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_nature_of_case">Nature of Case</label>
                            <input type="text" class="form-control" id="ci_cmap_nature_of_case" name="ci_cmap_nature_of_case" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_trial_court">Plaintiff</label>
                            <input type="text" class="form-control" id="ci_cmap_trial_court" name="ci_cmap_trial_court" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_sala_no">SALA No.</label>
                            <input type="text" class="form-control" id="ci_cmap_sala_no" name="ci_cmap_sala_no" maxlength="1000" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_case_no">Case No.</label>
                            <input type="text" class="form-control" id="ci_cmap_case_no" name="ci_cmap_case_no" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_cmap_reported_date">Reported Date</label>
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_cmap_reported_date" name="ci_cmap_reported_date" autocomplete="off">
                                <span class="input-group-text">
                                    <i class="feather icon-calendar"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" id="ci_cmap_remarks" name="ci_cmap_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-cmap" form="ci-cmap-form">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade modal-animate" id="ci-collateral-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
                ...
                <form id="ci-collateral-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_collateral_appraisal_date" name="ci_collateral_appraisal_date" autocomplete="off">
                                <span class="input-group-text">
                                    <i class="feather icon-calendar"></i>
                                </span>
                            </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <select class="form-control select2" name="ci_collateral_brand_id" id="ci_collateral_brand_id">
                                <option value="">--</option>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" id="ci_collateral_description" name="ci_collateral_description" maxlength="1000" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_color_id">Color</label>
                            <select class="form-control select2" name="ci_collateral_color_id" id="ci_collateral_color_id">
                                <option value="">--</option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control" id="ci_collateral_year_model" name="ci_collateral_year_model" maxlength="10" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_plate_no">Plate No.</label>
                            <input type="text" class="form-control" id="ci_collateral_plate_no" name="ci_collateral_plate_no" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_motor_no">Motor No.</label>
                            <input type="text" class="form-control" id="ci_collateral_motor_no" name="ci_collateral_motor_no" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_serial_no">Serial No.</label>
                            <input type="text" class="form-control" id="ci_collateral_serial_no" name="ci_collateral_serial_no" maxlength="100" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_mvr_file_no">MVR File No.</label>
                            <input type="text" class="form-control" id="ci_collateral_mvr_file_no" name="ci_collateral_mvr_file_no" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_cr_no">CR No.</label>
                            <input type="text" class="form-control" id="ci_collateral_cr_no" name="ci_collateral_cr_no" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_or_no">OR No.</label>
                            <input type="text" class="form-control" id="ci_collateral_or_no" name="ci_collateral_or_no" maxlength="100" autocomplete="off">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_registered_owner">Registered Owner</label>
                            <input type="text" class="form-control" id="ci_collateral_registered_owner" name="ci_collateral_registered_owner" maxlength="500" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_appraised_value">Appraised Value</label>
                            <input type="number" class="form-control" id="ci_collateral_appraised_value" name="ci_collateral_appraised_value" min="0" step="0.01">
                        </div>
                        <div class="col-lg-3">
                            <label class="form-label" for="ci_collateral_loannable_value">Loannable Value</label>
                            <input type="number" class="form-control" id="ci_collateral_loannable_value" name="ci_collateral_loannable_value" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-label" for="ci_collateral_remarks">Remarks</label>
                            <textarea class="form-control" id="ci_collateral_remarks" name="ci_collateral_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row align-items-center appraisal-source-hide d-none">
                        ...
                        <div class="col-sm-6 text-sm-end mb-3">
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#ci-appraisal-source-modal" id="add-ci-appraisal-source-deposits">Add Appraisal Source</button>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" id="submit-ci-collateral" form="ci-collateral-form">Submit</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <form id="ci-bank-deposits-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control regular-datepicker" id="ci_bank_deposits_deposit_month" name="ci_bank_deposits_deposit_month" autocomplete="off">
                                <span class="input-group-text">
                                    <i class="feather icon-calendar"></i>
                                </span>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" class="form-control" id="ci_bank_deposits_amount" name="ci_bank_deposits_amount" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-label" for="ci_bank_deposits_remarks">Remarks</label>
                            <textarea class="form-control" id="ci_bank_deposits_remarks" name="ci_bank_deposits_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="submit-ci-bank-deposits" form="ci-bank-deposits-form">Submit</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
                ...
                <form id="ci-appraisal-source-form" method="post" action="#">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" id="ci_appraisal_source_source" name="ci_appraisal_source_source" maxlength="3000" autocomplete="off">
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="ci_appraisal_source_amount">Amount <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="ci_appraisal_source_amount" name="ci_appraisal_source_amount" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <label class="form-label" for="ci_appraisal_source_remarks">Remarks</label>
                            <textarea class="form-control" id="ci_appraisal_source_remarks" name="ci_appraisal_source_remarks" maxlength="3000" rows="3"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="submit-ci-appraisal-source" form="ci-appraisal-source-form">Submit</button>
            </div>
        </div>
    </div>
</div>