    ...
    <div class="card table-card">
                ...
                if($postSTA['total'] > 0){
                  $action .= '<div class="btn-group m-r-10">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li><button class="dropdown-item" type="button" id="post-stock-transfer-advice">Post Stock Transfer Advice</button></li>
                                </ul>
                              </div>';
                  }
      ...
      <div class="card-body">
        <div class="table-responsive dt-responsive">
          <table id="stock-transfer-advice-posting-table" class="table table-hover nowrap w-100">
            <thead>
              <tr>
                <th class="all">
                    ...
                    <div class="row py-3">
                      <div class="col-12">
                        <div class="form-check my-2">
                          <input class="form-check-input sta-status-checkbox" type="checkbox" id="sta-status-draft" value="Draft"/>
                          <label class="form-check-label" for="sta-status-draft">Draft</label>
                        </div>
                        <div class="form-check my-2">
                          <input class="form-check-input sta-status-checkbox" type="checkbox" id="sta-status-on-process" value="On-Process"/>
                          <label class="form-check-label" for="sta-status-on-process">On-Process</label>
                        </div>
                        <div class="form-check my-2">
                          <input class="form-check-input sta-status-checkbox" type="checkbox" id="sta-status-completed" value="Completed" checked/>
