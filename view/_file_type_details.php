                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-6 text-sm-end mt-3 mt-sm-0">
                    <?php                            
                       if (!empty($fileTypeID)) {
                          $dropdown = '<div class="btn-group m-r-5">
                            ...
                            if ($fileTypeDuplicateAccess['total'] > 0) {
                                $dropdown .= '<li><button class="dropdown-item" type="button" data-file-type-id="' . $fileTypeID . '" id="duplicate-file-type">Duplicate File Type</button></li>';
                            }
                            
                            if ($fileTypeDeleteAccess['total'] > 0) {
                                $dropdown .= '<li><button class="dropdown-item" type="button" data-file-type-id="' . $fileTypeID . '" id="delete-file-type-details">Delete File Type</button></li>';
                            }
                      ...
                      if (!empty($fileTypeID) && $fileTypeWriteAccess['total'] > 0) {
                      ...
                      if (!empty($fileTypeID) && $fileTypeCreateAccess['total'] > 0) {
                      ...
                      <?php
                        if(!empty($fileTypeID) && $fileTypeWriteAccess['total'] > 0){
                           echo '<div class="form-group row">
                                                <input type="hidden" id="file_type_id" name="file_type_id" value="'. $fileTypeID .'">
          ...
          <?php
           if(!empty($fileTypeID)){
                if($fileExtensionCreateAccess['total'] > 0){
                    $file_extension_create = '<button type="button" class="btn btn-warning" id="create-file-extension">Add File Extension</button>';
                }
