                          ...
                          <div class="row py-3">
                            <div class="col-12">
                              <div class="form-check my-2">
                                <input class="form-check-input fund-source-filter" type="radio" name="fund-source-filter" id="fund-source-check" value="Journal Voucher" checked />
                                <label class="form-check-label" for="fund-source-check">Journal Voucher</label>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <div class="card table-card">
                ...
                <?php                 
                  if($disbursementCreateAccess['total'] > 0 || $disbursementDeleteAccess['total'] > 0 || $disbursementCreateAccess['total'] > 0){
                    ...
                    if($disbursementCreateAccess['total'] > 0){
                      $action .= '<a href="journal-voucher.php?new" class="btn btn-success">Create</a>';
                    }
          ...
          <div class="card-body">
            ...
            <div class="table-responsive dt-responsive">
              <table id="journal-voucher-table" class="table table-hover text-wrap w-100 text-uppercase">
                <thead>
                  <tr>
                    <th class="all">
