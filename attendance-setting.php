...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="attendance-setting.php"><?php echo $pageTitle; ?></a></li>
                  <?php
                    if(!$newRecord && !empty($attendanceSettingID)){
                      echo '<li class="breadcrumb-item" id="attendance-setting-id">'. $attendanceSettingID .'</li>';
                    }
        ...
        <?php
          if($newRecord && $attendanceSettingCreateAccess['total'] > 0){
            require_once('view/_attendance_setting_new.php');
          }
          else if(!empty($attendanceSettingID) && $attendanceSettingWriteAccess['total'] > 0){
            require_once('view/_attendance_setting_details.php');
          }
          else{
            require_once('view/_attendance_setting.php');
          }
        ?>
      </div>
    </section>
