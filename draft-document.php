<?php
  ...
  $pageTitle = 'Draft Document';
    
  $draftDocumentReadAccess = $userModel->checkMenuItemAccessRights($user_id, 57, 'read');
  $draftDocumentCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 57, 'create');
  $draftDocumentWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 57, 'write');
  ...
  if(isset($_GET['id'])){
    if(empty($_GET['id'])){
      header('location: draft-document.php');
      exit;
    }
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="draft-document.php"><?php echo $pageTitle; ?></a></li>
                    <?php
        ...
        <?php
          if($newRecord && $draftDocumentCreateAccess['total'] > 0){
            require_once('view/_draft_document_new.php');
          }
          else if(!empty($documentID) && $draftDocumentWriteAccess['total'] > 0){
            require_once('view/_draft_document_details.php');
          }
          else{
            require_once('view/_draft_document.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/draft-document.js?v=<?php echo rand(); ?>"></script>
</body>
