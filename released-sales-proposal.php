<?php
  ...
  $pageTitle = 'Released Sales Proposal';
  ...
  $allSalesProposalReadAccess = $userModel->checkMenuItemAccessRights($user_id, 110, 'read');
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
      ...
      <div class="pc-content">
        ...
        <?php
         if(!empty($salesProposalID) && !empty($customerID)){
            ...
            require_once('view/_released_sales_proposal.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/sales-proposal-released.js?v=<?php echo rand(); ?>"></script>
</body>
