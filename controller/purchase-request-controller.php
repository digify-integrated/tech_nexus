...
class PurchaseRequestController {
    ...
    public function savePurchaseRequest() {
        ...
        if ($total > 0) {
            $this->purchaseRequestModel->updatePurchaseRequest($purchase_request_id, $purchase_request_type, $department_id, $company_id, $month_coverage, $coverage_period, $remarks, $userID);
            ...
            $purchase_request_id = $this->purchaseRequestModel->insertPurchaseRequest($reference_number, $purchase_request_type, $department_id, $company_id, $month_coverage, $coverage_period, $remarks, $userID);
    ...
    public function getPurchaseRequestDetails() {
        ...
        if (isset($_POST['purchase_request_id']) && !empty($_POST['purchase_request_id'])) {
            ...
            $response = [
                ...
                'department_id' => $purchaseRequestDetails['department_id'],
