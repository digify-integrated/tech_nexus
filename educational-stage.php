            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="educational-stage.php">Educational Stage</a></li>
                    <?php
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Educational Stage</h2>
                </div>
              </div>
            </div>
          </div>
