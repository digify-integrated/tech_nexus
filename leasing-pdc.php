<?php
  ...
  $pageTitle = 'Leasing PDC';
    
  $pdcManagementReadAccess = $userModel->checkMenuItemAccessRights($user_id, 183, 'read');
  $pdcManagementCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 183, 'create');
  $pdcManagementWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 183, 'write');
  $pdcManagementDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 183, 'delete');
      ...
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="leasing-pdc.php"><?php echo $pageTitle; ?></a></li>
                    <?php
        ...
        <?php
          if($newRecord && $pdcManagementCreateAccess['total'] > 0){
            ...
            require_once('view/_leasing_pdc_management.php');
          }
        ?>
      </div>
    </section>
