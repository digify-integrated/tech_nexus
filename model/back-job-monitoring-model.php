...
class BackJobMonitoringModel {
    ...
    public function updateBackJobMonitoringJobOrder($p_backjob_monitoring_id, $p_backjob_monitoring_job_order_id, $p_progress, $p_contractor_id, $p_work_center_id, $p_completion_date, $p_cost, $p_job_order, $p_planned_start_date, $p_planned_finish_date, $p_date_started, $p_remarks, $p_company_id, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateBackJobMonitoringJobOrder(:p_backjob_monitoring_id, :p_backjob_monitoring_job_order_id, :p_progress, :p_contractor_id, :p_work_center_id, :p_completion_date, :p_cost, :p_job_order, :p_planned_start_date, :p_planned_finish_date, :p_date_started, :p_remarks, :p_company_id, :p_last_log_by)');
        $stmt->bindValue(':p_backjob_monitoring_id', $p_backjob_monitoring_id, PDO::PARAM_INT);
    ...
    public function updateBackJobMonitoringAsApproved($p_backjob_monitoring_id, $p_status, $p_approval_remarks, $p_last_log_by) {
     ...
     public function createBackjobJobOrderEntry($p_backjob_monitoring_id, $p_job_order_id, $p_entry_type, $debit_company_id, $p_company_id, $p_cost, $p_markup, $p_sold_status, $p_last_log_by): void {
        $stmt = $this->db->getConnection()->prepare('CALL createBackjobJobOrderEntry(:p_backjob_monitoring_id, :p_job_order_id, :p_entry_type, :debit_company_id, :p_company_id, :p_cost, :p_markup, :p_sold_status, :p_last_log_by)');
        ...
        $stmt->bindValue(':debit_company_id', $debit_company_id, PDO::PARAM_INT);
