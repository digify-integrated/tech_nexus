...
class SalesProposalModel {
    ...
    public function updateSalesProposalJobOrderProgress($p_sales_proposal_job_order_id, $p_cost, $p_progress, $p_contractor_id, $p_work_center_id, $p_backjob, $p_completion_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateSalesProposalJobOrderProgress(:p_sales_proposal_job_order_id, :p_cost, :p_progress, :p_contractor_id, :p_work_center_id, :p_backjob, :p_completion_date, :p_last_log_by)');
    ...
    public function updateSalesProposalAdditionalJobOrderProgress($sales_proposal_additional_job_order_id, $p_cost, $p_progress, $p_contractor_id, $p_work_center_id, $p_backjob, $p_completion_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateSalesProposalAdditionalJobOrderProgress(:sales_proposal_additional_job_order_id, :p_cost, :p_progress, :p_contractor_id, :p_work_center_id, :p_backjob, :p_completion_date, :p_last_log_by)');
