...
class ProductModel {
    ...
    public function updateProductDetails($p_product_id, $p_stock_number, $p_product_category_id, $p_product_subcategory_id, $p_company_id, $p_engine_number, $p_chassis_number, $p_plate_number, $p_description, $p_warehouse_id, $p_body_type_id, $p_length, $p_length_unit, $p_running_hours, $p_mileage, $p_color_id, $p_remarks, $p_orcr_no, $p_orcr_date, $p_orcr_expiry_date, $p_received_from, $p_received_from_address, $p_received_from_id_type, $p_received_from_id_number, $p_supplier_id, $p_ref_no, $p_brand_id, $p_cabin_id, $p_model_id, $p_make_id, $p_class_id, $p_mode_of_acquisition_id, $p_broker, $p_registered_owner, $p_mode_of_registration, $p_year_model, $p_arrival_date, $p_checklist_date, $p_with_cr, $p_with_plate, $p_returned_to_supplier, $p_quantity, $p_preorder, $p_is_service, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateProductDetails(:p_product_id, :p_stock_number, :p_product_category_id, :p_product_subcategory_id, :p_company_id, :p_engine_number, :p_chassis_number, :p_plate_number, :p_description, :p_warehouse_id, :p_body_type_id, :p_length, :p_length_unit, :p_running_hours, :p_mileage, :p_color_id, :p_remarks, :p_orcr_no, :p_orcr_date, :p_orcr_expiry_date, :p_received_from, :p_received_from_address, :p_received_from_id_type, :p_received_from_id_number, :p_supplier_id, :p_ref_no, :p_brand_id, :p_cabin_id, :p_model_id, :p_make_id, :p_class_id, :p_mode_of_acquisition_id, :p_broker, :p_registered_owner, :p_mode_of_registration, :p_year_model, :p_arrival_date, :p_checklist_date, :p_with_cr, :p_with_plate, :p_returned_to_supplier, :p_quantity, :p_preorder, :p_is_service, :p_last_log_by)');
        $stmt->bindValue(':p_product_id', $p_product_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_stock_number', $p_stock_number, PDO::PARAM_STR);
        $stmt->bindValue(':p_product_category_id', $p_product_category_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_product_subcategory_id', $p_product_subcategory_id, PDO::PARAM_INT);
        ...
        $stmt->bindValue(':p_preorder', $p_preorder, PDO::PARAM_STR);
        $stmt->bindValue(':p_is_service', $p_is_service, PDO::PARAM_STR);
        $stmt->bindValue(':p_last_log_by', $p_last_log_by, PDO::PARAM_INT);
        $stmt->execute();
    }

    public function updateProductLandedCost($p_product_id, $p_product_price, $p_best_price, $p_fx_rate, $p_converted_amount, $p_unit_cost, $p_package_deal, $p_taxes_duties, $p_freight, $p_lto_registration, $p_royalties, $p_conversion, $p_arrastre, $p_wharrfage, $p_insurance, $p_aircon, $p_import_permit, $p_others, $p_total_landed_cost, $p_payment_ref_no, $p_payment_ref_date, $p_payment_ref_amount, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateProductLandedCost(:p_product_id, :p_product_price, :p_best_price, :p_fx_rate, :p_converted_amount, :p_unit_cost, :p_package_deal, :p_taxes_duties, :p_freight, :p_lto_registration, :p_royalties, :p_conversion, :p_arrastre, :p_wharrfage, :p_insurance, :p_aircon, :p_import_permit, :p_others, :p_total_landed_cost, :p_payment_ref_no, :p_payment_ref_date, :p_payment_ref_amount, :p_last_log_by)');
        $stmt->bindValue(':p_product_id', $p_product_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_product_price', $p_product_price, PDO::PARAM_STR);
        $stmt->bindValue(':p_best_price', $p_best_price, PDO::PARAM_STR);
        $stmt->bindValue(':p_fx_rate', $p_fx_rate, PDO::PARAM_STR);
    ...
    public function insertProduct($p_product_category_id, $p_product_subcategory_id, $p_company_id, $p_stock_number, $p_engine_number, $p_chassis_number, $p_plate_number, $p_description, $p_warehouse_id, $p_body_type_id, $p_length, $p_length_unit, $p_running_hours, $p_mileage, $p_color_id, $p_remarks, $p_orcr_no, $p_orcr_date, $p_orcr_expiry_date, $p_received_from, $p_received_from_address, $p_received_from_id_type, $p_received_from_id_number, $p_rr_no, $p_supplier_id, $p_ref_no, $p_brand_id, $p_cabin_id, $p_model_id, $p_make_id, $p_class_id, $p_mode_of_acquisition_id, $p_broker, $p_registered_owner, $p_mode_of_registration, $p_year_model, $p_arrival_date, $p_checklist_date, $p_with_cr, $p_with_plate, $p_returned_to_supplier, $p_quantity, $p_preorder, $p_is_service, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertProduct(:p_product_category_id, :p_product_subcategory_id, :p_company_id, :p_stock_number, :p_engine_number, :p_chassis_number, :p_plate_number, :p_description, :p_warehouse_id, :p_body_type_id, :p_length, :p_length_unit, :p_running_hours, :p_mileage, :p_color_id, :p_remarks, :p_orcr_no, :p_orcr_date, :p_orcr_expiry_date, :p_received_from, :p_received_from_address, :p_received_from_id_type, :p_received_from_id_number, :p_rr_no, :p_supplier_id, :p_ref_no, :p_brand_id, :p_cabin_id, :p_model_id, :p_make_id, :p_class_id, :p_mode_of_acquisition_id, :p_broker, :p_registered_owner, :p_mode_of_registration, :p_year_model, :p_arrival_date, :p_checklist_date, :p_with_cr, :p_with_plate, :p_returned_to_supplier, :p_quantity, :p_preorder, :p_is_service, :p_last_log_by, @p_product_id)');
        $stmt->bindValue(':p_product_category_id', $p_product_category_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_product_subcategory_id', $p_product_subcategory_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_company_id', $p_company_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_stock_number', $p_stock_number, PDO::PARAM_STR);
    ...
    public function generateAllProductWithStockNumberOptions() {
        $stmt = $this->db->getConnection()->prepare('CALL generateAllProductOptions()');
        $stmt->execute();
        $options = $stmt->fetchAll(PDO::FETCH_ASSOC);
