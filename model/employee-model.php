...
class EmployeeModel {
    ...
    # -------------------------------------------------------------
    public function unarchiveEmployee($p_contact_id, $p_onboard_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL unarchiveEmployee(:p_contact_id, :p_onboard_date, :p_last_log_by)');
        $stmt->bindValue(':p_contact_id', $p_contact_id, PDO::PARAM_INT);
