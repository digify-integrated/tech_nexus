...
class PurchaseRequestModel {
    ...
    public function insertPurchaseRequest($p_reference_number, $p_purchase_request_type, $p_company_id, $p_remarks, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertPurchaseRequest(:p_reference_number, :p_purchase_request_type, :p_company_id, :p_remarks, :p_last_log_by)');
    ...
    public function updatePurchaseRequest($p_purchase_request_id, $p_purchase_request_type, $p_company_id, $p_remarks, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertPurchaseRequest(:p_purchase_request_id, :p_purchase_request_type, :p_company_id, :p_remarks, :p_last_log_by)');
        $stmt->bindValue(':p_purchase_request_id', $p_purchase_request_id, PDO::PARAM_STR);
        $stmt->bindValue(':p_purchase_request_type', $p_purchase_request_type, PDO::PARAM_STR);
        $stmt->bindValue(':p_company_id', $p_company_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_remarks', $p_remarks, PDO::PARAM_STR);
    ...
    public function deletePurchaseRequestCart($p_part_transaction_cart_id) {
        $stmt = $this->db->getConnection()->prepare('CALL deletePurchaseRequestCart(:p_part_transaction_cart_id)');
        $stmt->bindValue(':p_part_transaction_cart_id', $p_part_transaction_cart_id, PDO::PARAM_INT);
        $stmt->execute();
    }
    ...
    public function getPurchaseRequestCart($p_part_transaction_cart_id) {
        $stmt = $this->db->getConnection()->prepare('CALL getPurchaseRequestCart(:p_part_transaction_cart_id)');
        $stmt->bindValue(':p_part_transaction_cart_id', $p_part_transaction_cart_id, PDO::PARAM_INT);
        $stmt->execute();
        return $stmt->fetch(PDO::FETCH_ASSOC);
    }
