...
class DisbursementModel {
    ...
    #
    # -------------------------------------------------------------
    public function updateDisbursement($p_disbursement_id, $p_transaction_number, $p_reference_number, $p_customer_id, $p_department_id, $p_company_id, $p_transaction_type, $p_particulars, $p_disbursement_amount, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateDisbursement(:p_disbursement_id, :p_transaction_number, :p_reference_number, :p_customer_id, :p_department_id, :p_company_id, :p_transaction_type, :p_particulars, :p_disbursement_amount, :p_last_log_by)');
        ...
        $stmt->bindValue(':p_disbursement_amount', $p_disbursement_amount, PDO::PARAM_STR);
    ...
    #
    # -------------------------------------------------------------
    public function insertDisbursement($p_transaction_number, $p_reference_number, $p_customer_id, $p_department_id, $p_company_id, $p_transaction_type, $p_particulars, $p_disbursement_amount, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertDisbursement(:p_transaction_number, :p_reference_number, :p_customer_id, :p_department_id, :p_company_id, :p_transaction_type, :p_particulars, :p_disbursement_amount, :p_last_log_by, @p_disbursement_id)');
        $stmt->bindValue(':p_transaction_number', $p_transaction_number, PDO::PARAM_STR);
        $stmt->bindValue(':p_reference_number', $p_reference_number, PDO::PARAM_STR);
        $stmt->bindValue(':p_customer_id', $p_customer_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_department_id', $p_department_id, PDO::PARAM_INT);
