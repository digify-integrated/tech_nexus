...
class DisbursementModel {
    ...
    #
    # -------------------------------------------------------------
    public function updateDisbursement($p_disbursement_id, $p_payable_type, $p_customer_id, $p_department_id, $p_company_id, $p_transaction_number, $p_transaction_type, $p_fund_source, $p_particulars, $p_transaction_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateDisbursement(:p_disbursement_id, :p_payable_type, :p_customer_id, :p_department_id, :p_company_id, :p_transaction_number, :p_transaction_type, :p_fund_source, :p_particulars, :p_transaction_date, :p_last_log_by)');
    ...
    public function updateDisbursementParticulars($p_disbursement_particulars_id, $p_disbursement_id, $p_chart_of_account_id, $p_company_id, $p_remarks, $p_particulars_amount, $p_base_amount, $p_with_vat, $p_with_withholding, $p_vat_amount, $p_withholding_amount, $p_total_amount, $p_tax_quarter, $p_payroll_deduction, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateDisbursementParticulars(:p_disbursement_particulars_id, :p_disbursement_id, :p_chart_of_account_id, :p_company_id, :p_remarks, :p_particulars_amount, :p_base_amount, :p_with_vat, :p_with_withholding, :p_vat_amount, :p_withholding_amount, :p_total_amount, :p_tax_quarter, :p_payroll_deduction, :p_last_log_by)');
        ...
        $stmt->bindValue(':p_payroll_deduction', $p_payroll_deduction, PDO::PARAM_STR);
        $stmt->bindValue(':p_last_log_by', $p_last_log_by, PDO::PARAM_INT);
        $stmt->execute();
    }

    public function updateDisbursementCheck($p_disbursement_check_id, $p_disbursement_id, $p_bank_branch, $p_check_name, $p_check_number, $p_check_date, $p_check_amount, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL updateDisbursementCheck(:p_disbursement_check_id, :p_disbursement_id, :p_bank_branch, :p_check_name, :p_check_number, :p_check_date, :p_check_amount, :p_last_log_by)');
        $stmt->bindValue(':p_disbursement_check_id', $p_disbursement_check_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_disbursement_id', $p_disbursement_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_bank_branch', $p_bank_branch, PDO::PARAM_STR);
        $stmt->bindValue(':p_check_name', $p_check_name, PDO::PARAM_STR);
    ...
    #
    # -------------------------------------------------------------
    public function insertDisbursement($p_payable_type, $p_customer_id, $p_department_id, $p_company_id, $p_transaction_number, $p_transaction_type, $p_fund_source, $p_particulars, $p_transaction_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertDisbursement(:p_payable_type, :p_customer_id, :p_department_id, :p_company_id, :p_transaction_number, :p_transaction_type, :p_fund_source, :p_particulars, :p_transaction_date, :p_last_log_by, @p_disbursement_id)');
        $stmt->bindValue(':p_payable_type', $p_payable_type, PDO::PARAM_STR);
        $stmt->bindValue(':p_customer_id', $p_customer_id, PDO::PARAM_STR);
        $stmt->bindValue(':p_department_id', $p_department_id, PDO::PARAM_STR);
        $stmt->bindValue(':p_company_id', $p_company_id, PDO::PARAM_STR);
    ...
    public function insertDisbursementParticulars($p_disbursement_id, $p_chart_of_account_id, $p_company_id, $p_remarks, $p_particulars_amount, $p_base_amount, $p_with_vat, $p_with_withholding, $p_vat_amount, $p_withholding_amount, $p_total_amount, $p_tax_quarter, $p_payroll_deduction, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertDisbursementParticulars(:p_disbursement_id, :p_chart_of_account_id, :p_company_id, :p_remarks, :p_particulars_amount, :p_base_amount, :p_with_vat, :p_with_withholding, :p_vat_amount, :p_withholding_amount, :p_total_amount, :p_tax_quarter, :p_payroll_deduction, :p_last_log_by)');
        $stmt->bindValue(':p_disbursement_id', $p_disbursement_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_chart_of_account_id', $p_chart_of_account_id, PDO::PARAM_STR);
        $stmt->bindValue(':p_company_id', $p_company_id, PDO::PARAM_STR);
        $stmt->bindValue(':p_remarks', $p_remarks, PDO::PARAM_STR);
    ...
    public function insertDisbursementCheck($p_disbursement_id, $p_bank_branch, $p_check_name, $p_check_number, $p_check_date, $p_check_amount, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL insertDisbursementCheck(:p_disbursement_id, :p_bank_branch, :p_check_name, :p_check_number, :p_check_date, :p_check_amount, :p_last_log_by)');
        $stmt->bindValue(':p_disbursement_id', $p_disbursement_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_bank_branch',  $p_bank_branch, PDO::PARAM_STR);
        $stmt->bindValue(':p_check_name',  $p_check_name, PDO::PARAM_STR);
    ...
    public function createDisbursementEntry($p_disbursement_id, $p_transaction_number, $p_fund_source, $p_entry_type, $p_transaction_date, $p_last_log_by) {
        $stmt = $this->db->getConnection()->prepare('CALL createDisbursementEntry(:p_disbursement_id, :p_transaction_number, :p_fund_source, :p_entry_type, :p_transaction_date, :p_last_log_by)');
        $stmt->bindValue(':p_disbursement_id', $p_disbursement_id, PDO::PARAM_INT);
        $stmt->bindValue(':p_transaction_number', $p_transaction_number, PDO::PARAM_STR);
        $stmt->bindValue(':p_fund_source', $p_fund_source, PDO::PARAM_STR);
    ...
    public function getDisbursementCheckCount($p_disbursement_id) {
        $stmt = $this->db->getConnection()->prepare('CALL getDisbursementCheckCount(:p_disbursement_id)');
        $stmt->bindValue(':p_disbursement_id', $p_disbursement_id, PDO::PARAM_INT);
        $stmt->execute();
        return $stmt->fetch(PDO::FETCH_ASSOC);
    }
