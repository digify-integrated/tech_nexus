<?php
    ...
    $pdf->Ln(8);
    $pdf->Cell(130, 8, '2. UPFRONT/INITIAL PAYMENT', 0, 0, 'L');
    $pdf->Cell(20, 8, 'P   ', 0, 0, 'L');
    ...
    $pdf->Ln(8);
    $pdf->Cell(130, 8, '4. OTHER CHARGES (TO BE COLLECTED SEPARATELY TO BORROWER/BUYER)', 0, 0, 'L');
    $pdf->Cell(70, 8, '', 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(10, 8, '       '  , 0, 0, 'L');
    ...
    $pdf->Ln(8);
    $pdf->Cell(10, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, "c. Liquidated damages- further sum of 25% in addition to costs and other litigation expenses." , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(10, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, "d. Collection Fee:" , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(20, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, 'Within Cabanatuan City and adjacent city/municipality' , 0, 0, 'L');
    $pdf->Cell(32, 8, 'P 2,000.00' , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(20, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, 'Other city/municipalities in Nueva Ecija' , 0, 0, 'L');
    $pdf->Cell(32, 8, 'P 5,000.00' , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(20, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, 'Adjacent provinces' , 0, 0, 'L');
    $pdf->Cell(32, 8, 'P 7,000.00' , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(20, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, 'Other provinces which will require overnight stay' , 0, 0, 'L');
    $pdf->Cell(32, 8, 'P 10,000.00' , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(10, 8, '       '  , 0, 0, 'L');
    $pdf->Cell(100, 8, "e. Pull-out fee of PDCs per check due to insufficiency of funds" , 0, 0, 'L');
    $pdf->Ln(8);
    $pdf->Cell(10, 8, '       '  , 0, 0, 'L');
    ...
    $pdf->Cell(10, 4, '     ', 0, 0 , 'L');
    $pdf->Ln(10);
    $pdf->MultiCell(0, 0, "<b>This is a system-generated Disclosure Statement on Loans and Credit Transaction and does not require a signature from Christian General Motors Inc.</b>", 0, 'J', 0, 1, '', '', true, 0, true, true, 0);
