<?php
  ...
  $pageTitle = 'Product Expense';
  
  $productReadAccess = $userModel->checkMenuItemAccessRights($user_id, 117, 'read');
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
        ...
        <?php
         require_once('view/_product_expense.php');
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/product-expense.js?v=<?php echo rand(); ?>"></script>
</body>
