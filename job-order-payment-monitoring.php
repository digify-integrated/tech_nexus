<?php
  ...
  $pageTitle = 'Job Order Payment Monitoring';
  ...
  $allSalesProposalReadAccess = $userModel->checkMenuItemAccessRights($user_id, 173, 'read');
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
        ...
        <?php
            require_once('view/_job_order_payment_monitoring.php');
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/job-order-payment-monitoring.js?v=<?php echo rand(); ?>"></script>
</body>
