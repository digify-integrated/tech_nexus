(function($) {
    ...
    $(function() {
        ...
        if($('#closed-leasing-summary-table').length){
            closedLeasingSummaryTable('#closed-leasing-summary-table');
        }
...
function closedLeasingSummaryTable(datatable_name, buttons = false, show_all = false){
    const type = 'closed leasing summary table';
    var settings;
