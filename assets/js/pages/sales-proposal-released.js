(function($) {
    ...
    $(function() {
        ...
        if($('#released-sales-proposal-table').length){
            releasedSalesProposalTable('#released-sales-proposal-table');
        }
...
function releasedSalesProposalTable(datatable_name, buttons = false, show_all = false){
    const type = 'released sales proposal table';
