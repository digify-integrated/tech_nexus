<?php
   ...
   // Disable header and footer
    ...
    $pdf->Cell(10, 8, '', 0, 0, 'L');
    $pdf->Cell(60, 8, strtoupper($createdByName), 'B', 0, 'L');
    $pdf->Cell(5, 4, ' ', 0, 0 , 'L');
    ...
    $pdf->Cell(10, 8, '', 0, 0, 'L');
    $pdf->Cell(60, 8, strtoupper($createdByJobPositionName), 'B', 0, 'L');
    $pdf->Cell(5, 4, ' ', 0, 0 , 'L');
    $pdf->Cell(20, 8, 'Department:', 0, 0, 'L');
    $pdf->Cell(10, 8, '', 0, 0, 'L');
    $pdf->Cell(60, 8, strtoupper($createdByDepartmentName), 'B', 0, 'L');
    $pdf->Ln(15);
    ...
    $pdf->Ln(0);
    $pdf->Cell(40, 8, 'Prepared By:', 0, 0, 'L');
    $pdf->Cell(10, 4, '     ', 0, 0 , 'L');
    $pdf->Cell(40, 8, 'Checked By:', 0, 0, 'L');
    $pdf->Cell(10, 4, '     ', 0, 0 , 'L');
    $pdf->Cell(40, 8, 'Recommended By:', 0, 0, 'L');
    $pdf->Cell(10, 4, '     ', 0, 0 , 'L');
    $pdf->Cell(40, 8, 'Approved By:', 0, 0, 'L');
