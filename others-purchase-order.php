<?php
  ...
  $pageTitle = 'Others Purchase Order';
    
  $purchaseOrderReadAccess = $userModel->checkMenuItemAccessRights($user_id, 185, 'read');
  $purchaseOrderCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 185, 'create');
  $purchaseOrderWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 185, 'write');
  $purchaseOrderDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 185, 'delete');
  $purchaseOrderDuplicateAccess = $userModel->checkMenuItemAccessRights($user_id, 185, 'duplicate');
  ...
  if(isset($_GET['id'])){
    if(empty($_GET['id'])){
      header('location: others-purchase-order.php');
      exit;
    }
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
      ...
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="others-purchase-order.php"><?php echo $pageTitle; ?></a></li>
                    <?php
        ...
        <?php
          if($newRecord && $purchaseOrderCreateAccess['total'] > 0){
            require_once('view/_others_purchase_order_new.php');
          }
          else if(!empty($purchaseOrderID) && $purchaseOrderWriteAccess['total'] > 0){
            require_once('view/_others_purchase_order_details.php');
          }
          else{
            require_once('view/_others_purchase_order.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/others-purchase-order.js?v=<?php echo rand(); ?>"></script>
</body>
