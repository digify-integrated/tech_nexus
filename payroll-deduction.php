<?php
  ...
  $liquidationReadAccess = $userModel->checkMenuItemAccessRights($user_id, 186, 'read');
  $liquidationCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 186, 'create');
  $liquidationWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 186, 'write');
  $liquidationDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 186, 'delete');
      ...
      <div class="pc-content">
        ...
        <?php
          if(!empty($liquidationID) && $liquidationWriteAccess['total'] > 0){
            ...
            require_once('view/_payroll_deduction.php');
          }
        ?>
      </div>
    </section>
