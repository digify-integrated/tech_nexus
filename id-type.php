...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast="false" data-pc-theme="light">
    ...
    <section class="pc-container">
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="id-type.php">ID Type</a></li>
                    <?php
                        if(!$newRecord && !empty($idTypeID)){
                            echo '<li class="breadcrumb-item" id="id-type-id">'. $idTypeID .'</li>';
                        }
        ...
        <?php
          if($newRecord && $idTypeCreateAccess['total'] > 0){
            require_once('view/_id_type_new.php');
          }
          else if(!empty($idTypeID) && $idTypeWriteAccess['total'] > 0){
            require_once('view/_id_type_details.php');
          }
          else{
            require_once('view/_id_type.php');
          }
        ?>
      </div>
    </section>
    ...
    <script src="./assets/js/pages/id-type.js?v=<?php echo rand(); ?>"></script>
</body>
