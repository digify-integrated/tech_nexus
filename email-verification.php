...
<body>
    ...
    <div class="auth-main">
        <div class="auth-wrapper v2">
            ...
            <form class="auth-form" id="email-verification-form" method="post" action="#">
                <div class="card my-5">
                    <div class="card-body">
                        ...
                        <p class="">We`ve sent a verification code to your email - <?php echo $emailObscure; ?></p>
                        <div class="form-group mb-3">
                            <input type="hidden" id="user_id" name="user_id" value="<?php echo $id; ?>>">
                            <input type="text" class="form-control" id="verification_code" name="verification_code" placeholder="Verification Code" autocomplete="off">
                        </div>
