<?php
  ...
  $pageTitle = 'Fuel Incoming';
    
  $partsIncomingReadAccess = $userModel->checkMenuItemAccessRights($user_id, 188, 'read');
  $partsIncomingCreateAccess = $userModel->checkMenuItemAccessRights($user_id, 188, 'create');
  $partsIncomingWriteAccess = $userModel->checkMenuItemAccessRights($user_id, 188, 'write');
  $partsIncomingDeleteAccess = $userModel->checkMenuItemAccessRights($user_id, 188, 'delete');
  $partsIncomingDuplicateAccess = $userModel->checkMenuItemAccessRights($user_id, 188, 'duplicate');
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="fuel-incoming.php"><?php echo $pageTitle; ?></a></li>
                    <?php
